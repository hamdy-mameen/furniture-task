...
import com.example.furnituretask.viewModels.OffersDetailsViewModel
...
class OfferDetailsFragment: Fragment() {
    ...
    private val viewModel:OffersDetailsViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupRecyclerView()
        setupPagerAdapter()
        viewModel.getOfferDetails(args.id)
        viewModel.offersDetailsLiveData.observe(viewLifecycleOwner, Observer {resources->
            when(resources){
                ...
                is Resources.Success ->{
                   ...
                   binding?.let {
                       ...
                       it.productPrice.text = "${offer.price}"
                       it.productFurniture.text = "${offer.furniture_name}"
